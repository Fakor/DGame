#-------------------------------------------------
#
# Project created by QtCreator 2019-02-02T22:01:04
#
#-------------------------------------------------
...
win32:CONFIG(release, debug|release): LIBS += -L$$OUT_PWD/../graphics/release/ -lgraphics
else:win32:CONFIG(debug, debug|release): LIBS += -L$$OUT_PWD/../graphics/debug/ -lgraphics
else:unix: LIBS += -L$$OUT_PWD/../graphics/ -lgraphics

INCLUDEPATH += $$PWD/../graphics
DEPENDPATH += $$PWD/../graphics

win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../graphics/release/libgraphics.a
else:win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../graphics/debug/libgraphics.a
else:win32:!win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../graphics/release/graphics.lib
else:win32:!win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$OUT_PWD/../graphics/debug/graphics.lib
else:unix: PRE_TARGETDEPS += $$OUT_PWD/../graphics/libgraphics.a
